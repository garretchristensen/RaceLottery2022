...
The 2022 lottery is picking 62 men, 66 women, a 75 person male waitlist, and a 44 person women waitlist (all remaining women entrants) from the 415 total applicants (110 women, 305 men). 
...
temp<-read.csv("./test2022_noemail.csv", stringsAsFactors = FALSE) #LOAD THE DATA
df<-as_tibble(temp)
...
### 2022 Waitlist
There are two separate waitlists, one for men (75) and one for women (all remaining 44).
